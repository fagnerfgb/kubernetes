...
```bash
kubectl apply -f namespace-obj.yaml
kubectl get all
kubectl get all -o wide
kubectl get all -n default
kubectl get all -n producao
kubectl delete -f namespace-obj.yaml
```

```bash
kubectl apply -f namespace-obj.yaml -n producao
...
```bash
kubectl apply -f namespace-obj-dec.yaml
kubectl get all
